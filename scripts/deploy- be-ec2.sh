...
deploy_env_file="/etc/moyeota/backend-deploy.env"
...
current_env=".deploy/backend.env"
previous_env=".deploy/backend.previous.env"
...
trap - EXIT
rm -f "$previous_env"
echo "Backend deployment succeeded: $RELEASE_ID"
